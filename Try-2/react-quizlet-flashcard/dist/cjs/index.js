...
function Flashcard({ front, back, className, reset }) {
    const [isFlipped, setFlipped] = react.exports.useState(false);
    // To reset flip state
    react.exports.useEffect(() => {
        setFlipped(false);
    }, [reset]);
    return (React.createElement("div", { className: `FlashcardWrapper ${className}` },
        React.createElement("div", { className: `FlashcardWrapper__item ${isFlipped ? "FlashcardWrapper__item--flip" : ""}`, onClick: () => setFlipped(!isFlipped) },
            React.createElement("div", { className: "FlashcardWrapper__item--front" },
                React.createElement("div", { className: "FlashcardWrapper__item--content" }, front)),
            React.createElement("div", { className: "FlashcardWrapper__item--back" },
                React.createElement("div", { className: "FlashcardWrapper__item--content" }, back)))));
}
Flashcard.propTypes = {
    front: PropTypes__default["default"].string,
    back: PropTypes__default["default"].string,
